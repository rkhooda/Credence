...
export const CREDENTIALVAULT_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "error",
    "name": "CredentialNotPending",
    "inputs": []
  },
  {
    "type": "error",
    "name": "CredentialNotRevocable",
    "inputs": []
  },
  {
    "type": "error",
