...
// Source: Backend-Contracts/src/AssetNFT.sol
// Regenerate: npm run contract:abi
export const ASSETNFT_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
