...
export function describeError(err: unknown): string {
  ...
  const named: Record<string, string> = {
    ...
    UnauthorizedVerifier: "This wallet is not authorized to manage identities on the IdentityRegistry.",
    AccessControlUnauthorizedAccount: "This wallet is not authorized for this platform action.",
    DIDNotFound: "The identity no longer exists on-chain. Refresh the identities list.",
    IdentityRevokedErr: "This identity has already been revoked.",
    IdentitySuspendedErr: "This identity is suspended and cannot be verified.",
    InvalidStatusTransition: "That identity status transition is not allowed.",
